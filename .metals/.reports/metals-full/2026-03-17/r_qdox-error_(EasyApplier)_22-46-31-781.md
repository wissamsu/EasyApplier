error id: file://<WORKSPACE>/src/main/java/com/Wissam/EasyApplier/AbstractJohn.java
file://<WORKSPACE>/src/main/java/com/Wissam/EasyApplier/AbstractJohn.java
...
```java
offset: 0
uri: file://<WORKSPACE>/src/main/java/com/Wissam/EasyApplier/AbstractJohn.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/Wissam/EasyApplier/AbstractJohn.java