error id: file://<WORKSPACE>/src/main/java/com/Wissam/EasyApplier/Calculator.java
file://<WORKSPACE>/src/main/java/com/Wissam/EasyApplier/Calculator.java
...
```java
offset: 87
uri: file://<WORKSPACE>/src/main/java/com/Wissam/EasyApplier/Calculator.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/Wissam/EasyApplier/Calculator.java